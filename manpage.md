...
```
  ...
  yaavt.lua join [options] <path> [path] ...               - join a list of file paths into one media file, in specified format
```
...
-o <path>
: set output path (only used by 'join' command, autogenerated when not supplied)
