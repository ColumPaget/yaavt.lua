...
print("  yaavt.lua join [options] <path> [path] ...               - join a list of file paths into one media file, in specified format")
print("options:")
print("  -f <fmt>              - set output format to use")
print("  -o <path>             - set output path for 'join' command (otherwise it's autogenerated)")
...
local actions={"help", "version", "formats", "convert", "batch", "join"}
local i, item

if conf.action=="-?" then conf.action="help"
elseif conf.action=="-help" then conf.action="help"
elseif conf.action=="-help" then conf.action="help"
elseif conf.action=="--help" then conf.action="help" 
elseif conf.action=="--version" then conf.action="version" 
elseif conf.action=="-version" then conf.action="version" 
...
elseif conf.action=="--batch" then conf.action="batch" 
elseif conf.action=="-join" then conf.action="join" 
elseif conf.action=="--join" then conf.action="join" 
end
